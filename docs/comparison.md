...
- **Snapshot:** [Unity 6000.0](../unity-plugin/package.json);
...
| Chat window inside Unity | **Biome:** [bundled multi-backend Chat](chat/using-chat.md)<br>**Unity MCP Server:** [separate Unity AI Assistant in the same package](https://unity.com/blog/unity-ai-how-to-get-started)<br>**Not documented:** MCP for Unity, AI Game Developer, MCP Unity |
