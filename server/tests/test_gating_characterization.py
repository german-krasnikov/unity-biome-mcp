...
_TIER1_SNAPSHOT = frozenset({
    ...
    "get_console", "get_enabled_tools", "get_hierarchy", "get_test_results",
    ...
    "run_playtest", "run_scenario", "run_tests", "scene", "screenshot",
...
_ALL_KNOWN_SNAPSHOT = frozenset({
    ...
    "execute_code", "find_objects", "fingerprint", "fuzz_playtest",
    ...
    "get_test_results", "get_watches", "inspect", "invoke_method",
    "list_connections", "list_scenarios", "list_skills", "list_templates",
    ...
    "resolve_tool_schema", "run_playtest", "run_scenario", "run_tests",
    "save_scenario", "save_session",
...
_THEMED_CATEGORIES_SNAPSHOT = {
    ...
    "SESSION_SKILLS": {"apply_template", "fingerprint", "get_changes", "list_scenarios",
                        "list_skills", "list_templates", "load_scenario", "load_session",
                        "save_scenario", "save_session", "save_skill",
    ...
    "UNIT_TESTS": {"fuzz_playtest", "get_test_count", "get_test_results",
                   "run_playtest", "run_scenario", "run_tests", "test_step"},
    "VFX": {"vfx_intent"},
}
...
_TIMEOUT_CATEGORIES_SNAPSHOT = {
    ...
    "fuzz_playtest": 300.0, "get_console": 10.0, "get_hierarchy": 15.0,
    "get_test_count": 10.0, "get_version": 5.0, "import_package": 120.0,
    "ping": 5.0, "run_playtest": 300.0, "run_scenario": 300.0, "run_tests": 300.0,
    "search_scene": 15.0,
}
