...
_ALL_KNOWN_SNAPSHOT = frozenset({
    ...
    "resolve_tool_schema", "run_playtest", "run_tests", "save_session",
...
_THEMED_CATEGORIES_SNAPSHOT = {
    ...
    "SESSION_SKILLS": {"apply_template", "fingerprint", "get_changes", "list_skills",
                        "list_templates", "load_session", "save_session", "save_skill",
    ...
    "UNIT_TESTS": {"fuzz_playtest", "get_test_count", "get_test_results",
                   "run_playtest", "run_tests", "test_step"},
    "VFX": {"vfx_intent"},
}
...
_TIMEOUT_CATEGORIES_SNAPSHOT = {
    ...
    "ping": 5.0, "run_playtest": 300.0, "run_tests": 300.0, "search_scene": 15.0,
}
