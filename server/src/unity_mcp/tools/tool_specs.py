...
_SPECS: dict[str, ToolSpec] = {
    ...
    'end_write_session':   ToolSpec(category='ASSETS', tier1=True, direct_only=True, unity_transport=True),
    ...
    'start_write_session': ToolSpec(category='ASSETS', mutability='write', direct_only=True, unity_transport=True),
