...
_SPECS: dict[str, ToolSpec] = {
    ...
    'doctor': ToolSpec(category='SYSTEM', tier1=True, mutability='read'),
    'editor': ToolSpec(category='CORE', core=True),
    'execute_code': ToolSpec(category='SYSTEM', timeout_s=60.0),
    'export_package': ToolSpec(category='_INTERNAL', timeout_s=120.0),
    'export_playtest_aliases_to_defs': ToolSpec(category='TESTS', tier1=True),
    ...
    'get_enabled_tools': ToolSpec(category='SYSTEM', tier1=True, mutability='read'),
    ...
    'get_test_progress': ToolSpec(category='TESTS', tier1=True, mutability='read'),
    ...
    'invoke_method': ToolSpec(category='RUNTIME', tier1=True, runtime_only=True),
    'lint_playtest': ToolSpec(category='TESTS', tier1=True, timeout_s=60.0, mutability='read'),
    'lint_playtest_suite': ToolSpec(category='TESTS', tier1=True, timeout_s=120.0, mutability='read'),
    'lint_scene_refs': ToolSpec(category='VERIFY', tier1=True, mutability='read'),
    'list_connections': ToolSpec(category='SYSTEM', tier1=True, mutability='read'),
    ...
    'move_to': ToolSpec(category='RUNTIME', tier1=True, runtime_only=True),
    ...
    'query_state': ToolSpec(category='RUNTIME', tier1=True, mutability='read', runtime_only=True),
    ...
    'run_playtest_file': ToolSpec(category='TESTS', tier1=True, timeout_s=300.0, mutability='read'),
    'run_playtest_suite': ToolSpec(category='TESTS', tier1=True, timeout_s=3600.0, mutability='read'),
    ...
    'search_scene': ToolSpec(category='CORE', core=True, timeout_s=15.0, mutability='read'),
    'set_active': ToolSpec(category='SCENE'),
    ...
    'set_runtime_property': ToolSpec(category='RUNTIME', tier1=True, runtime_only=True),
    ...
    'sync_playtest_aliases_from_defs': ToolSpec(category='TESTS', tier1=True),
    'sync_unity': ToolSpec(category='SYSTEM', tier1=True),
    'test_step': ToolSpec(category='TESTS', tier1=True, runtime_only=True, mutability='read'),
    ...
    'validate_playtest_aliases': ToolSpec(category='TESTS', tier1=True, mutability='read'),
    'validate_references': ToolSpec(category='VERIFY', mutability='read'),
    ...
    'wait_until': ToolSpec(category='RUNTIME', tier1=True, runtime_only=True, mutability='read'),
