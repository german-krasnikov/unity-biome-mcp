...
_SPECS: dict[str, ToolSpec] = {
    ...
    'apply_scene_change': ToolSpec(category='SCENE', core=True, timeout_s=120.0),
    'apply_template': ToolSpec(category='SYSTEM'),
    'ask': ToolSpec(category='SYSTEM', tier1=True, mutability='read', direct_only=True),
    ...
    'mcp_status': ToolSpec(category='SYSTEM', tier1=True, mutability='read', direct_only=True),
    ...
    'release_smoke': ToolSpec(category='SYSTEM', tier1=True, mutability='read', direct_only=True),
    ...
    'scene_change_plan': ToolSpec(category='SCENE', core=True, timeout_s=30.0),
    ...
    'ui_intent': ToolSpec(category='MEDIA', direct_only=True),
    ...
    'validate_playtest_aliases': ToolSpec(category='TESTS', mutability='read', direct_only=True),
    'validate_references': ToolSpec(category='VERIFY', tier1=True, mutability='read'),
    'verify_after_change': ToolSpec(category='VERIFY', core=True, timeout_s=600.0, mutability='read'),
