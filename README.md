...
<!-- README_STATS_START -->
<img src="docs/assets/stats.svg" width="100%" alt="142 registered MCP tools. Test inventory: 11021 entries: 4286 regular Python, 511 Python stress, 289 live Python, and 5935 Unity source attributes. Unity count source: static source scan. Server package version: v1.9.1.">
<!-- README_STATS_END -->
...
<!-- CHANGELOG_START -->
**Current release: v1.9.1 (2026-07-31).** [Read the full changelog.](CHANGELOG.md)
<!-- CHANGELOG_END -->
