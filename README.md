...
<!-- README_STATS_START -->
<img src="docs/assets/stats.svg" width="100%" alt="145 registered MCP tools. Test inventory: 11498 entries: 4537 regular Python, 511 Python stress, 287 live Python, and 6163 Unity source attributes. Unity count source: static source scan. Server package version: v1.10.3.">
<!-- README_STATS_END -->
...
<!-- CHANGELOG_START -->
**Current release: v1.10.3 (2026-08-03).** [Read the full changelog.](CHANGELOG.md)
<!-- CHANGELOG_END -->
