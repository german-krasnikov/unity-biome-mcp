...
<!-- README_STATS_START -->
<img src="docs/assets/stats.svg" width="100%" alt="148 registered MCP tools. Test inventory: 12513 entries: 4881 regular Python, 511 Python stress, 334 live Python, and 6787 Unity source attributes. Unity count source: static source scan. Server package version: v1.30.0.">
<!-- README_STATS_END -->
...
<!-- CHANGELOG_START -->
**Current release: v1.30.0 (2026-08-12).** [Read the full changelog.](CHANGELOG.md)
<!-- CHANGELOG_END -->
