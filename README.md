...
<!-- README_STATS_START -->
<img src="docs/assets/stats.svg" width="100%" alt="163 registered MCP tools. Test inventory: 15324 entries: 6150 regular Python, 511 Python stress, 637 live Python, and 8026 Unity source attributes. Unity count source: static source scan. Server package version: v1.50.5.">
<!-- README_STATS_END -->
