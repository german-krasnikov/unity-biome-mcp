...
<!-- README_STATS_START -->
<img src="docs/assets/stats.svg" width="100%" alt="160 registered MCP tools. Test inventory: 13925 entries: 5603 regular Python, 511 Python stress, 444 live Python, and 7367 Unity source attributes. Unity count source: static source scan. Server package version: v1.39.0.">
<!-- README_STATS_END -->
...
<!-- CHANGELOG_START -->
**Current release: v1.39.0 (2026-08-17).** [Read the full changelog.](CHANGELOG.md)
<!-- CHANGELOG_END -->
