...
<!-- README_STATS_START -->
<img src="docs/assets/stats.svg" width="100%" alt="160 registered MCP tools. Test inventory: 16514 entries: 6648 regular Python, 511 Python stress, 658 live Python, and 8697 Unity source attributes. Unity count source: static source scan. Server package version: v2.0.0.">
<!-- README_STATS_END -->
