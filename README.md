...
<!-- README_STATS_START -->
<img src="docs/assets/stats.svg" width="100%" alt="160 registered MCP tools. Test inventory: 15372 entries: 6118 regular Python, 511 Python stress, 634 live Python, and 8109 Unity source attributes. Unity count source: static source scan. Server package version: v1.51.0.">
<!-- README_STATS_END -->
...
<!-- CHANGELOG_START -->
**Current release: v1.51.0 (2026-09-01).** [Read the full changelog.](CHANGELOG.md)
<!-- CHANGELOG_END -->
