...
<!-- README_STATS_START -->
<img src="docs/assets/stats.svg" width="100%" alt="152 registered MCP tools. Test inventory: 13126 entries: 5221 regular Python, 511 Python stress, 334 live Python, and 7060 Unity source attributes. Unity count source: static source scan. Server package version: v1.35.0.">
<!-- README_STATS_END -->
...
<!-- CHANGELOG_START -->
**Current release: v1.35.0 (2026-08-15).** [Read the full changelog.](CHANGELOG.md)
<!-- CHANGELOG_END -->
