...
<!-- README_STATS_START -->
<img src="docs/assets/stats.svg" width="100%" alt="160 registered MCP tools. Test inventory: 16059 entries: 6405 regular Python, 511 Python stress, 636 live Python, and 8507 Unity source attributes. Unity count source: static source scan. Server package version: v1.53.0.">
<!-- README_STATS_END -->
...
<!-- CHANGELOG_START -->
**Current release: v1.53.0 (2026-09-05).** [Read the full changelog.](CHANGELOG.md)
<!-- CHANGELOG_END -->
