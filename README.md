...
<!-- README_STATS_START -->
<img src="docs/assets/stats.svg" width="100%" alt="141 registered MCP tools. Test inventory: 11179 entries: 4401 regular Python, 511 Python stress, 289 live Python, and 5978 Unity source attributes. Unity count source: static source scan. Server package version: v1.10.0.">
<!-- README_STATS_END -->
...
<!-- CHANGELOG_START -->
**Current release: v1.10.0 (2026-08-01).** [Read the full changelog.](CHANGELOG.md)
<!-- CHANGELOG_END -->
