...
<!-- README_STATS_START -->
<img src="docs/assets/stats.svg" width="100%" alt="160 registered MCP tools. Test inventory: 13773 entries: 5561 regular Python, 511 Python stress, 334 live Python, and 7367 Unity source attributes. Unity count source: static source scan. Server package version: v1.37.2.">
<!-- README_STATS_END -->
