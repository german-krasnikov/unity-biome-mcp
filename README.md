...
<!-- README_STATS_START -->
<img src="docs/assets/stats.svg" width="100%" alt="148 registered MCP tools. Test inventory: 12081 entries: 4817 regular Python, 511 Python stress, 334 live Python, and 6419 Unity source attributes. Unity count source: static source scan. Server package version: v1.26.0.">
<!-- README_STATS_END -->
