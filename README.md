...
<!-- README_STATS_START -->
<img src="docs/assets/stats.svg" width="100%" alt="142 registered MCP tools. Test inventory: 10985 entries: 4265 regular Python, 511 Python stress, 289 live Python, and 5920 Unity source attributes. Unity count source: static source scan. Server package version: v1.6.0.">
<!-- README_STATS_END -->
...
<!-- CHANGELOG_START -->
**Current release: v1.6.0 (2026-07-30).** [Read the full changelog.](CHANGELOG.md)
<!-- CHANGELOG_END -->
