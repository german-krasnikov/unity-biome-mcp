...
<!-- README_STATS_START -->
<img src="docs/assets/stats.svg" width="100%" alt="160 registered MCP tools. Test inventory: 14298 entries: 5776 regular Python, 511 Python stress, 634 live Python, and 7377 Unity source attributes. Unity count source: static source scan. Server package version: v1.42.0.">
<!-- README_STATS_END -->
