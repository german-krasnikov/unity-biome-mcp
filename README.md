...
<!-- README_STATS_START -->
<img src="docs/assets/stats.svg" width="100%" alt="148 registered MCP tools. Test inventory: 11699 entries: 4607 regular Python, 511 Python stress, 287 live Python, and 6294 Unity source attributes. Unity count source: static source scan. Server package version: v1.20.0.">
<!-- README_STATS_END -->
