...
<!-- README_STATS_START -->
<img src="docs/assets/stats.svg" width="100%" alt="163 registered MCP tools. Test inventory: 15308 entries: 6145 regular Python, 511 Python stress, 637 live Python, and 8015 Unity source attributes. Unity count source: static source scan. Server package version: v1.50.2.">
<!-- README_STATS_END -->
...
<!-- CHANGELOG_START -->
**Current release: v1.50.2 (2026-08-23).** [Read the full changelog.](CHANGELOG.md)
<!-- CHANGELOG_END -->
