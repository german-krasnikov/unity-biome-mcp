...
<!-- README_STATS_START -->
<img src="docs/assets/stats.svg" width="100%" alt="157 registered MCP tools. Test inventory: 13335 entries: 5275 regular Python, 511 Python stress, 334 live Python, and 7215 Unity source attributes. Unity count source: static source scan. Server package version: v1.34.0.">
<!-- README_STATS_END -->
...
<!-- CHANGELOG_START -->
**Current release: v1.34.0 (2026-08-14).** [Read the full changelog.](CHANGELOG.md)
<!-- CHANGELOG_END -->
