...
<!-- README_STATS_START -->
<img src="docs/assets/stats.svg" width="100%" alt="148 registered MCP tools. Test inventory: 11626 entries: 4591 regular Python, 511 Python stress, 287 live Python, and 6237 Unity source attributes. Unity count source: static source scan. Server package version: v1.15.0.">
<!-- README_STATS_END -->
...
<!-- CHANGELOG_START -->
**Current release: v1.15.0 (2026-08-05).** [Read the full changelog.](CHANGELOG.md)
<!-- CHANGELOG_END -->
