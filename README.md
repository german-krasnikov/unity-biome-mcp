...
<!-- README_STATS_START -->
<img src="docs/assets/stats.svg" width="100%" alt="160 registered MCP tools. Test inventory: 16058 entries: 6405 regular Python, 511 Python stress, 636 live Python, and 8506 Unity source attributes. Unity count source: static source scan. Server package version: v1.52.0.">
<!-- README_STATS_END -->
