...
Record the selected mode and filter with the terminal result. A focused run
supports only the claims covered by that selection; it is not evidence for an
unexecuted suite.
