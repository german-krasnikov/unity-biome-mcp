...
namespace UnityMCP.Editor.Tests
{
    ...
    public class CommandRegistryCompletenessTests
    {
        ...
        private static readonly string[] BaseCommands =
        {
            ...
            "get_test_progress", "get_test_results", "get_watches", "inspect", "invoke_method", "manage_component",
            ...
            "scriptable_object", "search_scene", "set_active", "set_client_label", "set_material", "set_parent",
            "set_property", "set_property_delta", "set_rect", "set_runtime_property",
            "set_sibling_index", "set_tool_catalog", "shader", "spatial_query", "sync", "sync_status", "test_step",
