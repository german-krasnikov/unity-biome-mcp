    ...
    public static class MCPSettings
    {
        ...
        private static readonly Dictionary<string, string[]> _defaultCatalog =
            new Dictionary<string, string[]>
            {
                ...
                { "MEDIA",      new[] { "analyze_lod_culling","animation","animator","particle","render_analyze","screenshot","screenshot_baseline","screenshot_compare","timeline" } },
                { "UGUI",       new[] { "create_ui","lint_ugui","set_rect" } },
