...
- [`reload-reference.md`](reload-reference.md): current sync contract and its dated Unity research basis.
...
| Batch execution | [`batch.md`](batch.md) |
| Connections and code lifecycle | [`connection-tools.md`](connection-tools.md), [`code-intel.md`](code-intel.md) |
...
| Editor menu and chrome | [`menu.md`](menu.md) |
